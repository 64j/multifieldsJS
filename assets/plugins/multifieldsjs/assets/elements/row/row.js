    ...
    actions: {
      ...
      offset: function(e) {
        ...
        document.onmouseup = function(e) {
          ...
          [...parent.attributes].map(function(attr) {
            if (attr.name.substr(0, 17) === 'data-mfjs-offset-' && typeof MfJs.Config.get('settings')?.toolbar?.breakpoints?.[attr.name.substr(17)] === 'undefined') {
      ...
      col: function(e) {
        ...
        document.onmouseup = function(e) {
          ...
          for (let k in MfJs.Config.get('settings')?.toolbar?.breakpoints) {
            if (MfJs.Config.get('settings').toolbar.breakpoints.hasOwnProperty(k)) {
          ...
          [...parent.attributes].map(function(attr) {
            if (attr.name.substr(0, 14) === 'data-mfjs-col-' && typeof MfJs.Config.get('settings')?.toolbar?.breakpoints?.[attr.name.substr(14)] === 'undefined') {
              parent.removeAttribute(attr.name);
            }
          });
